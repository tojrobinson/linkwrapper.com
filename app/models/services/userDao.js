...
var validUser = require('r/app/models/user');
var BSON = require('mongodb').BSONPure;
var config = require('r/config/settings');

exports.getUser = function(criteria, done) {
...
exports.updateUser = function(userId, mod, done) {
   db.users.update(
         {_id: userId},
         mod,
...
exports.handleRemoteUser = function(type, remoteUser, done) {
   ...
   db.users.findOne({type: type, remote_id: remoteUser.id}, function(err, user) {
      if (err) {
         ...
         console.log(validUser(newUser, true));
...
exports.listUsers = function(criteria, done) {
...
exports.addCategory = function(userId, title, done) {
...
exports.removeCategory = function(userId, title, done) {
   db.users.findOne({_id: userId}, function(err, user) {
      if (err) {
         console.log(err);
         done(err);
...
exports.addPlaylist = function(userId, title, done) {
   db.users.findOne({_id: userId}, function(err, user) {
      if (err) {
         console.log(err);
         done(err);
